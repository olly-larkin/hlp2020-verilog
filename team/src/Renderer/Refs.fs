...
let runSimulationBtn = getHtml "run" :?> HTMLButtonElement
let visualiseBtn = getHtml "visualise" :?> HTMLButtonElement
...
let runPage url () =
    ...
    options.icon <- Some(U2.Case2 "app/assets/favicon.ico")
