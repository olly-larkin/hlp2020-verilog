...
let fontSizeChanger: HTMLSelectElement =
    Browser.document.getElementById("fontSizeChanger") :?> HTMLSelectElement
...
let visualise: HTMLButtonElement =
    Browser.document.getElementById("visualise") :?> HTMLButtonElement
